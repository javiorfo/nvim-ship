...
use {
    ...
    requires = { 'progrimorio/nvim-spinetta', 'progrimorio/nvim-popcorn' }
}
```
`Lazy`
```lua
{
    ...
    dependencies = { 'progrimorio/nvim-spinetta', 'progrimorio/nvim-popcorn' },
    config = function()
...
<img src="https://github.com/progrimorio/img/blob/master/nvim-ship/ship_file.png" alt="ship file" />
...
<img src="https://github.com/progrimorio/img/blob/master/nvim-ship/ship_simple.gif" alt="ship simple" />

#### With response in popup
<img src="https://github.com/progrimorio/img/blob/master/nvim-ship/ship_popup.gif" alt="ship popup" />

**NOTE:** These test examples are placed in this [folder](https://github.com/progrimorio/nvim-ship/tree/master/tests/ships)
...
<img src="https://github.com/progrimorio/img/blob/master/nvim-ship/ship_environment.gif" alt="ship file" />
...
<img src="https://github.com/progrimorio/img/blob/master/nvim-ship/ship_special.gif" alt="ship special" />
...
## Issues
- If you have any issue or you find a bug, please let me know about it reporting an issue [here](https://github.com/progrimorio/nvim-ship/issues)
