...
use {
    'charkuils/nvim-ship',
    requires = { 'charkuils/nvim-spinetta', 'charkuils/nvim-popcorn' }
}
```
`Lazy`
```lua
{
    ...
    dependencies = { 'charkuils/nvim-spinetta', 'charkuils/nvim-popcorn' },
    config = function()
...
<img src="https://github.com/charkuils/img/blob/master/nvim-ship/ship_file.png" alt="ship file" />
...
<img src="https://github.com/charkuils/img/blob/master/nvim-ship/ship_simple.gif" alt="ship simple" />

#### With response in popup
<img src="https://github.com/charkuils/img/blob/master/nvim-ship/ship_popup.gif" alt="ship popup" />
...
<img src="https://github.com/charkuils/img/blob/master/nvim-ship/ship_environment.gif" alt="ship file" />
...
<img src="https://github.com/charkuils/img/blob/master/nvim-ship/ship_special.gif" alt="ship special" />
